...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      desc: "'Hear Me Out' is a minimal, dark theme music player made with React, Typescript, Redux, and Netlify that lets you search and play sample songs using Spotify's Web API.",
      projectUrl: "https://hear-me-out.netlify.app/",
  ...
  return (
    <section className={classes.projectSection}>
      <header className={classes.projectHeader} id="Projects">
        Projects
      </header>
